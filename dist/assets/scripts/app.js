!function(e) {
        ...
        !function(e, n) {
            ...
            var T = function(e) {
                var t, n, i, o, r, s, a, l, c, d, u, p, f, h, v, g, y, m, b, w = "sizzle" + 1 * new Date, x = e.document, k = 0, T = 0, S = le(), C = le(), $ = le(), A = le(), E = function(e, t) {
                    return e === t && (u = !0), 0;
                }, j = {}.hasOwnProperty, O = [], D = O.pop, N = O.push, H = O.push, L = O.slice, P = function(e, t) {
                    for (var n = 0, i = e.length; n < i; n++) if (e[n] === t) return n;
                    return -1;
                }, q = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", M = "[\\x20\\t\\r\\n\\f]", z = "(?:\\\\[\\da-fA-F]{1,6}" + M + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", I = "\\[" + M + "*(" + z + ")(?:" + M + "*([*^$|!~]?=)" + M + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + z + "))|)" + M + "*\\]", W = ":(" + z + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + I + ")*)|.*)\\)|)", R = new RegExp(M + "+", "g"), F = new RegExp("^" + M + "+|((?:^|[^\\\\])(?:\\\\.)*)" + M + "+$", "g"), B = new RegExp("^" + M + "*," + M + "*"), _ = new RegExp("^" + M + "*([>+~]|" + M + ")" + M + "*"), U = new RegExp(M + "|>"), X = new RegExp(W), Y = new RegExp("^" + z + "$"), V = {
                    ID: new RegExp("^#(" + z + ")"),
                    CLASS: new RegExp("^\\.(" + z + ")"),
                    TAG: new RegExp("^(" + z + "|[*])"),
                    ATTR: new RegExp("^" + I),
                ...
                try {
                    H.apply(O = L.call(x.childNodes), x.childNodes), O[x.childNodes.length].nodeType;
                } catch (e) {
                    H = {
                ...
                return me.prototype = i.filters = i.pseudos, i.setFilters = new me, s = ae.tokenize = function(e, t) {
                    ...
                    for (a = e, l = [], c = i.preFilter; a; ) {
                        ...
                        n = !1, (o = _.exec(a)) && (n = o.shift(), r.push({
                            value: n,
                            type: o[0].replace(F, " ")
            ...
            var N = /^(?:parents|prev(?:Until|All))/, H = {
                children: !0,
                contents: !0,
                next: !0,
                prev: !0
            ...
            x.fn.extend({
                ...
                x.fn[e] = function(n, i) {
                    ...
                    this.length > 1 && (H[e] || x.uniqueSort(o), N.test(e) && o.reverse()), this.pushStack(o);
                };
            }));
            var P = /[^\x20\t\r\n\f]+/g;
            function q(e) {
            ...
            x.extend({
                ...
                clone: function(e, t, n) {
                    ...
                    i = 0, o = (r = ye(e)).length; i < o; i++) Le(r[i], s[i]);
                    if (t) if (n) for (r = r || ye(e), s = s || ye(a), i = 0, o = r.length; i < o; i++) He(r[i], s[i]); else He(e, a);
            ...
            var Me = new RegExp("^(" + ee + ")(?!px)[a-z%]+$", "i"), ze = /^--/, Ie = function(t) {
                ...
                return i;
            }, Re = new RegExp(ne.join("|"), "i"), Fe = "[\\x20\\t\\r\\n\\f]", Be = new RegExp("^" + Fe + "+|((?:^|[^\\\\])(?:\\\\.)*)" + Fe + "+$", "g");
            function _e(e, t, n) {
                var i, o, r, s, a = ze.test(t), l = e.style;
                return (n = n || Ie(e)) && (s = n.getPropertyValue(t) || n[t], a && s && (s = s.replace(Be, "$1") || void 0), 
            ...
            function tt(e, t, n) {
                var i = Ie(e), o = (!f.boxSizingReliable() || n) && "border-box" === x.css(e, "boxSizing", !1, i), r = o, s = _e(e, t, i), a = "offset" + t[0].toUpperCase() + t.slice(1);
                if (Me.test(s)) {
                    if (!n) return s;
                    s = "auto";
                }
            ...
            x.extend({
                ...
                css: function(e, t, n, i) {
                    ...
                    void 0 === o && (o = _e(e, t, i)), "normal" === o && t in Ke && (o = Ke[t]), "" === n || n ? (r = parseFloat(o), 
                ...
                if (t) return (parseFloat(_e(e, "marginLeft")) || e.getBoundingClientRect().left - We(e, {
                    marginLeft: 0
                }, (function() {
            ...
            var Ot = /%20/g, Dt = /#.*$/, Nt = /([?&])_=[^&]*/, Ht = /^(.*?):[ \t]*([^\r\n]*)$/gm, Lt = /^(?:GET|HEAD)$/, Pt = /^\/\//, qt = {}, Mt = {}, zt = "*/".concat("*"), It = g.createElement("a");
            function Wt(e) {
                return function(t, n) {
            ...
            It.href = kt.href, x.extend({
                ...
                ajax: function(t, n) {
                    ...
                    f.type = f.type.toUpperCase(), f.hasContent = !Lt.test(f.type), o = f.url.replace(Dt, ""), 
            ...
            2 === Ut.childNodes.length), x.parseHTML = function(e, t, n) {
                ...
                x.cssHooks[t] = Ue(f.pixelPosition, (function(e, n) {
                    if (n) return n = _e(e, t), Me.test(n) ? x(e).position()[t] + "px" : n;
                }));
            })), x.each({
                Height: "height",
                Width: "width"
    ...
    function r(e) {
        ...
        $(".countryList ul li a,.videoButton").on("click", (function() {
            var e, n, i, o, r, s = $(this).find("span").text(), a = $(this).find("img:first-child").attr("src"), l = $(this).data("popup-content"), c = $(this).data("popup-buttons"), d = $(this).data("footbutton-text");
            return e = s, n = a, i = l, o = c, r = d, (t = $("#popupContent")).find(".popupHead").find("h2").text(e), 
            t.find(".popupHead").find("img").attr("src", n), t.find(".popupBody").html(i), t.find(".popupFooter").find(".buttonsAppend").html(o), 
            t.find(".popupFooter").find(".footTextAppend").html(r), t.fadeIn(), $("#popupContent").removeClass("videoPopup"), 
            !1;
        })), $(".popupClose").on("click", (function() {
            t.hide(), (t = $("#popupContent")).find(".popupHead").find("h2").text(""), t.find(".popupHead").find("img").removeAttr("src"), 
            t.find(".popupBody").html(""), t.find(".popupFooter").find(".buttonsAppend").html(""), 
            t.find(".popupFooter").find(".footTextAppend").html("");
        })), $(".videoButton").on("click", (function() {
            return $("#popupContent").addClass("videoPopup"), !1;
        })), "#video" == window.location.hash && $(".videoButton").trigger("click");
    }
